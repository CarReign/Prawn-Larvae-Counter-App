...
function processCount(imageMat, kernelSize = 3) {
    ...
    (0, opencv_js_1.dilate)(processedMat, processedMat, (0, opencv_js_1.getStructuringElement)(opencv_js_1.MORPH_ELLIPSE, new opencv_js_1.Size(kernelSize, kernelSize)));
    const contours = new opencv_js_1.MatVector();
    (0, opencv_js_1.findContours)(processedMat, contours, new opencv_js_1.Mat(), opencv_js_1.RETR_TREE, opencv_js_1.CHAIN_APPROX_SIMPLE);
...
function getCountWithSpecificKernelSize(imageMat, kernelSize) {
    ...
    return (contours === null || contours === void 0 ? void 0 : contours.size()) || 0;
}
...
function getAverageCount(imageMat) {
    ...
    for (let i = 2; i <= 6; i++) {
        ...
        counts.push((contours === null || contours === void 0 ? void 0 : contours.size()) || 0);
