...
export default function PondTab(){
    ...
    const toggleEditPondModal = () => {
        setisEditPondModalVisible(!isEditPondModalVisible);
    };
    ...
    const handleEditPond = (pond: any) => {
        ...
        setisEditPondModalVisible(false);
      };
    ...
    return <>
        ...
        }
        {
            !loading && <View>
                ...
                {
                    ponds ?
                    [...ponds, ...ponds, ...ponds].map((pond, index) => {
                        return (
        ...
        {isAddPondModalVisible && (
            <View>
                <Overlay/>
                <AddPondModal onClose={toggleAddPondModal} onAddPond={handleAddPond} />
            </View>
        )}
        {isEditPondModalVisible && (
            <View>
                <Overlay/>
                <EditPondModal onClose={toggleEditPondModal} onEditPond={handleEditPond} />
            </View>
        )}
        </View>
    </>
